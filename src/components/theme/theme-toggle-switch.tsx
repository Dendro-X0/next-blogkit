...
export function ThemeToggleSwitch(): React.ReactElement {
  ...
  if (!mounted) {
    return (
      ...
      >
        <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-background shadow-lg" />
      </button>
    );
  }
  return (
    ...
    >
      <motion.div
        className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-background shadow-lg"
